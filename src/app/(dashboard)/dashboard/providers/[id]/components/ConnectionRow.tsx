...
import {
  ...
  type ConnectionStatusPresentationResult,
...
function getStatusPresentation(
  ...
  return getConnectionStatusPresentation(connection, effectiveStatus, isCooldown, t);
}
...
export default function ConnectionRow({
  ...
  isCcCompatible,
  cliproxyapiEnabled: _cliproxyapiEnabled,
  upstreamProxyMode,
  ...
  onToggleCodex5h,
  onToggleCodexWeekly,
  onToggleCliproxyapiMode: _onToggleCliproxyapiMode,
  onRetest,
  isRetesting,
  onEdit,
  onDelete,
