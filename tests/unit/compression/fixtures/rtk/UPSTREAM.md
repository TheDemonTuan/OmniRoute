# RTK v0.47.0 Fixture Provenance

Fixtures in this directory are OmniRoute-owned recreations of semantic behaviors audited against `rtk-ai/rtk` `v0.47.0`.

| Fixture group | Upstream baseline | Reference                                  | Source                                 | License                       |
| ------------- | ----------------- | ------------------------------------------ | -------------------------------------- | ----------------------------- |
| `ctest`       | v0.47.0           | `c75522e200d6133bca79ef2ba777c29ae9b1df6d` | Independently recreated semantic cases | Apache-2.0 upstream reference |
